...
# Example usage
def grobid(pdf_path, grobid_url, outdir):
    parser = argparse.ArgumentParser()
    parser.add_argument("--pdf", default=pdf_path, help="Path to local PDF file")
    parser.add_argument("--grobid-url", default=grobid_url, help="Base GROBID URL")
